    ...
    <div className="space-y-8">
      <div className="rounded-[10px] bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500 p-8 text-white shadow-[0_20px_50px_rgba(16,185,129,.30)]">
        <div className="flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
          <div>
            ...
            <h1 className="mt-3 text-4xl font-bold">Good Evening 👋</h1>

            <p className="mt-3 max-w-xl leading-7 text-emerald-100">
              Track your expenses, monitor budgets and analyze your financial
              health.
            </p>
          </div>
      ...
      <div className="grid grid-cols-12 gap-7">
        <div className="col-span-12 xl:col-span-8">
          <ExpenseTable transactions={data?.recentTransactions || []} />
        </div>

        <div className="col-span-12 space-y-7 xl:col-span-4">
          <Analytics analytics={data?.categoryAnalytics || []} />

          <DailyChart dailyData={data?.dailyExpenses || []} />
        </div>
      </div>
    </div>
  );
